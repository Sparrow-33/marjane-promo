  ...
  <div class="bg-white h-full rounded-2xl dark:bg-gray-700">
    ...
    <nav class="mt-6 px-2 ">
      <div>
        ...
        <a  class="w-full font-thin uppercase text-gray-500 dark:text-gray-200 flex items-center p-4 my-2 transition-colors duration-200 justify-start hover:bg-blue-700 hover:text-white rounded-full" href="display.products.admin">
                            <span class="text-left">
        ...
        <a href="display.promo.admin"  class="w-full font-thin uppercase text-gray-500 dark:text-gray-200 flex items-center p-4 my-2 transition-colors duration-200 justify-start hover:bg-blue-700 hover:text-white rounded-full" href="#">
                <span class="text-left">
