  ...
  >
    <div class="flex items-end justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
      ...
      <div class="relative inline-block px-4 pt-5 pb-4 overflow-hidden text-left align-bottom transition-all transform bg-white rounded-lg shadow-xl dark:bg-gray-900 sm:my-8 sm:w-full sm:max-w-sm sm:p-6 sm:align-middle">
        <h3 class="text-lg text-center font-medium leading-6 text-gray-800 capitalize dark:text-white" id="modal-title">
          Ajouter un admin
        </h3>
        <form class="mt-4" action="addAdmin.adminGeneral" method="post">
          <label for="" class="text-sm text-gray-700 dark:text-gray-200 ">
            Nom complet
            <input type="text" name="nom" id="nom" placeholder="admin"  class="block w-full px-4 py-3 mb-5 text-sm text-gray-700 bg-white border border-gray-200 rounded-md focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:focus:border-blue-300" />
          </label>

          <label for="" class="text-sm text-gray-700 dark:text-gray-200">
            Centre à affecter
            <select name="centre"  id="" class="block w-full px-4 py-3 text-sm text-gray-700 bg-white border border-gray-200 rounded-md focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:focus:border-blue-300">
          ...
          <label for="" class="text-sm text-gray-700 dark:text-gray-200">
            Email
            <input type="email" name="email" id="email" placeholder="admin"  class="block w-full px-4 py-3 mb-5 text-sm text-gray-700 bg-white border border-gray-200 rounded-md focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:focus:border-blue-300" />
          </label>

          <label for="" class="text-sm text-gray-700 dark:text-gray-200">
            mot de passe
            <input type="password" name="password" id="password" placeholder="admin"  class="block w-full px-4 py-3 text-sm text-gray-700 bg-white border border-gray-200 rounded-md focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:focus:border-blue-300" />
          </label>
